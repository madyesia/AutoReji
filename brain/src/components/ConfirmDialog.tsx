  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 z-50 w-[420px] max-w-[92vw] -translate-x-1/2 -translate-y-1/2 rounded-2xl glass p-5 shadow-[var(--shadow-pop)] focus:outline-none">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              ...
              <Dialog.Description className="mt-1 text-[12.5px] leading-snug text-fg-muted">{desc}</Dialog.Description>
            </div>
          </div>
