    ...
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="lg-a" x1="6" y1="3" x2="26" y2="29" gradientUnits="userSpaceOnUse">
          <stop stopColor="#fce4b3" />
          <stop offset="0.55" stopColor="#eab866" />
          <stop offset="1" stopColor="#b67d34" />
        </linearGradient>
        <linearGradient id="lg-b" x1="8" y1="8" x2="24" y2="26" gradientUnits="userSpaceOnUse">
          <stop stopColor="#0b0e14" />
      ...
      <path d="M14.4 14.6l4.1 2.5-4.1 2.5v-5Z" fill="#0b0e14" fillOpacity="0.85" />
    </svg>
  )
}
